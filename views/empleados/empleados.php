<link rel="stylesheet" href="<?php echo BASE_URL; ?>public/css/empleados.css?v=8">
...
<div class="contenedor">
    ...
    <div class="top-bar">
        ...
        <h2 class="titulo">Módulo Empleados</h2>
    ...
    <div class="buscador">
        <form method="POST" class="acciones">
            ...
            <a href="index.php?modulo=empleados" class="btn-pdf">Mostrar todos</a>

            <!-- pdf -->
            <a href="index.php?pdf=1&modulo=empleados" target="_blank" class="btn-pdf">
                PDF
            </a>
        </form>
    </div>
            ...
            <tbody>
                <?php if(!empty($datos)){ ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="acciones">
                                <a href="index.php?modulo=empleados&editar=<?= $item['folio'] ?? '' ?>" class="btn-actualizar">Actualizar</a>
                                <a href="index.php?modulo=empleados&eliminar=<?= $item['folio'] ?? '' ?>" class="btn-eliminar">Eliminar</a>
                            </div>
                        </td>
                    </tr>
